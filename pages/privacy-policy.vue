...
<template>
  <div class="legal-page container">
    <TheTitle tag="h1" size="l">Політика конфіденційності</TheTitle>
    ...
    <div class="legal-page__section">
      ...
      <p class="legal-page__text">
        ...
        персональні дані користувачів сайту. Використовуючи сайт, ви погоджуєтесь з умовами
        цієї Політики.
      </p>
    </div>
    ...
    <div class="legal-page__section">
      ...
      <p class="legal-page__text">
        ...
        від несанкціонованого доступу, зміни, розголошення або знищення. Передача платіжних даних
    ...
    <div class="legal-page__section">
      ...
      <p class="legal-page__text">
        ...
        персоналізації контенту. Ви можете вимкнути cookie у налаштуваннях браузера, однак це
